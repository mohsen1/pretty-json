...
(() => {
  ...
  var JSONBigInt = (0, import_json_bigint.default)({ useNativeBigInt: true });
  var PrettyJSONError = class extends Error {
    /**
     *
  ...
  var _input, _isExpanded, _PrettyJSON_instances, getCssVariables_fn, styles_get, expandAttributeValue_get, truncateStringAttributeValue_get, toggle_fn, createChild_fn, isPrimitiveValue_fn, isValidStringURL_fn, createPrimitiveValueElement_fn, createTruncatedStringElement_fn, createContainer_fn, stringifyWithBigInt_fn, createObjectOrArray_fn, createArrowElement_fn, createKeyElement_fn, render_fn;
  var _PrettyJSON = class _PrettyJSON extends HTMLElement {
    constructor() {
      super();
      __privateAdd(this, _PrettyJSON_instances);
      /**
       * @type {any}
       */
    ...
    attributeChangedCallback(name, _oldValue, newValue) {
      if (name === "expand") {
        if (newValue === null) {
          ...
          __privateSet(this, _isExpanded, !isNaN(expandValue) && expandValue > 0);
        }
        __privateMethod(this, _PrettyJSON_instances, render_fn).call(this);
      }
    }
    connectedCallback() {
      try {
        __privateSet(this, _input, JSONBigInt.parse(this.textContent ?? ""));
  ...
  _PrettyJSON_instances = new WeakSet();
  getCssVariables_fn = function() {
    const prefersDarkMode = window.matchMedia(
      "(prefers-color-scheme: dark)"
    ).matches;
    const variables = prefersDarkMode ? _PrettyJSON.DEFAULT_VARIABLES.dark : _PrettyJSON.DEFAULT_VARIABLES.light;
    if (!this.shadowRoot) {
      return variables;
    }
  ...
  styles_get = function() {
    const variables = __privateMethod(this, _PrettyJSON_instances, getCssVariables_fn).call(this);
    return `/* css */
    :host {
  ...
  expandAttributeValue_get = function() {
  ...
  truncateStringAttributeValue_get = function() {
  ...
  toggle_fn = function() {
    ...
    this.setAttribute(
      "expand",
      __privateGet(this, _isExpanded) ? String(__privateGet(this, _PrettyJSON_instances, expandAttributeValue_get) + 1) : "0"
    );
    __privateMethod(this, _PrettyJSON_instances, render_fn).call(this);
  };
  /**
   ...
   * @returns {HTMLElement}
   */
  createChild_fn = function(input, expand, key) {
    if (__privateMethod(this, _PrettyJSON_instances, isPrimitiveValue_fn).call(this, input)) {
      const container = __privateMethod(this, _PrettyJSON_instances, createContainer_fn).call(this);
      container.appendChild(__privateMethod(this, _PrettyJSON_instances, createPrimitiveValueElement_fn).call(this, input));
      return container;
    }
    return __privateMethod(this, _PrettyJSON_instances, createObjectOrArray_fn).call(this, input);
  };
  /**
   * @param {any} input
   * @returns {input is Primitive}
   */
  isPrimitiveValue_fn = function(input) {
    return typeof input !== "object" || input === null;
  };
  isValidStringURL_fn = function() {
    try {
      new URL(__privateGet(this, _input));
      return true;
    } catch (error) {
      return false;
    }
   ...
   * @returns {HTMLElement}
   */
  createPrimitiveValueElement_fn = function(input) {
    const container = document.createElement("div");
    const type = typeof input === "object" ? "null" : typeof input;
    container.className = `primitive value ${type}`;
    if (typeof input === "string") {
      if (__privateMethod(this, _PrettyJSON_instances, isValidStringURL_fn).call(this)) {
        const anchor = document.createElement("a");
        anchor.className = "url";
        anchor.href = __privateGet(this, _input);
        anchor.target = "_blank";
        anchor.textContent = input;
        container.append('"', anchor, '"');
      } else if (input.length > __privateGet(this, _PrettyJSON_instances, truncateStringAttributeValue_get)) {
        container.appendChild(__privateMethod(this, _PrettyJSON_instances, createTruncatedStringElement_fn).call(this, input));
      } else {
   ...
   * @param {string} input
   */
  createTruncatedStringElement_fn = function(input) {
    const container = document.createElement("div");
    ...
    ellipsis.addEventListener("click", () => {
      ...
      const expandedString = input.slice(
        0,
        (expandedTimes + 1) * __privateGet(this, _PrettyJSON_instances, truncateStringAttributeValue_get)
      );
    ...
    container.append(
      '"',
      input.slice(0, __privateGet(this, _PrettyJSON_instances, truncateStringAttributeValue_get)),
      ellipsis,
      '"'
    );
    return container;
   ...
   * @returns {string}
   */
  stringifyWithBigInt_fn = function(value) {
   ...
   * @returns {HTMLElement}
   */
  createObjectOrArray_fn = function(object) {
    const isArray = Array.isArray(object);
    const objectKeyName = this.getAttribute("key");
    const expand = __privateGet(this, _PrettyJSON_instances, expandAttributeValue_get);
    const truncateString = __privateGet(this, _PrettyJSON_instances, truncateStringAttributeValue_get);
    const container = __privateMethod(this, _PrettyJSON_instances, createContainer_fn).call(this);
    container.classList.add(isArray ? "array" : "object");
    if (objectKeyName) {
      container.classList.add("row");
      const keyElement = __privateMethod(this, _PrettyJSON_instances, createKeyElement_fn).call(this, objectKeyName, {
        withArrow: true,
        expanded: __privateGet(this, _isExpanded)
      });
      keyElement.addEventListener("click", __privateMethod(this, _PrettyJSON_instances, toggle_fn).bind(this));
    ...
    if (!__privateGet(this, _isExpanded)) {
      ...
      ellipsis.addEventListener("click", __privateMethod(this, _PrettyJSON_instances, toggle_fn).bind(this));
      container.appendChild(closingBrace);
      return container;
    }
    Object.entries(object).forEach(([key, value], index) => {
      if (__privateMethod(this, _PrettyJSON_instances, isPrimitiveValue_fn).call(this, value)) {
        const rowContainer = document.createElement("div");
        rowContainer.className = "row";
        if (!isArray) {
          const keyElement = __privateMethod(this, _PrettyJSON_instances, createKeyElement_fn).call(this, key);
          rowContainer.appendChild(keyElement);
        }
        rowContainer.appendChild(__privateMethod(this, _PrettyJSON_instances, createPrimitiveValueElement_fn).call(this, value));
      ...
      prettyJsonElement.textContent = __privateMethod(this, _PrettyJSON_instances, stringifyWithBigInt_fn).call(this, value);
      prettyJsonElement.setAttribute("expand", String(expand - 1));
      prettyJsonElement.setAttribute("truncate-string", String(truncateString));
   ...
   * @returns {SVGElement}
   */
  createArrowElement_fn = function({ expanded = false } = {}) {
   ...
   * @returns {HTMLElement}
   */
  createKeyElement_fn = function(key, { withArrow = false, expanded = false } = {}) {
    const keyElement = document.createElement(withArrow ? "button" : "span");
    keyElement.className = "key";
    if (withArrow) {
      const arrow = __privateMethod(this, _PrettyJSON_instances, createArrowElement_fn).call(this, { expanded });
  ...
  render_fn = function() {
    ...
    this.shadowRoot.appendChild(
      __privateMethod(this, _PrettyJSON_instances, createChild_fn).call(this, __privateGet(this, _input), __privateGet(this, _PrettyJSON_instances, expandAttributeValue_get))
    );
    ...
    styles.textContent = __privateGet(this, _PrettyJSON_instances, styles_get);
    this.shadowRoot.appendChild(styles);
  };
  // Default colors and styles
  __publicField(_PrettyJSON, "DEFAULT_VARIABLES", {
    light: {
      keyColor: "#cc0000",
      arrowColor: "#737373",
      braceColor: "#0030f0",
